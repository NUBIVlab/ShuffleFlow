"""
    ...
    Adapted from https://github.com/devzhk/InverseBench/blob/main/models/adm.py.
    Official implementation: https://github.com/openai/guided-diffusion.
"""
