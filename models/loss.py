"""
    Loss functions for the training of diffusion models.
    Adapted from https://github.com/devzhk/InverseBench/blob/main/models/loss.py.
"""
...
class VPLoss:
    """
        Loss function corresponding to the variance preserving (VP) formulation from the paper 
        "Score-Based Generative Modeling through Stochastic Differential Equations".
    """
    def __init__(self, beta_d=19.9, beta_min=0.1, epsilon_t=1e-5, **kwargs):
        self.beta_d = beta_d
...
class VELoss:
    """
        Loss function corresponding to the variance exploding (VE) formulation from the paper 
        "Score-Based Generative Modeling through Stochastic Differential Equations".
    """
    def __init__(self, sigma_min=0.02, sigma_max=100, **kwargs):
...
class EDMLoss:
    """
        Loss function corresponding to the EDM formulation from the paper 
